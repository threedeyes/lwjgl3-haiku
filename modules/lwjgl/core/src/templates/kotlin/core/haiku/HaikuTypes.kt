...
val flock = struct(Module.CORE_HAIKU, "Flock", nativeName = "flock64") {
...
val f_owner_ex = struct(Module.CORE_HAIKU, "FOwnerEx", nativeName = "f_owner_ex") {
    int("type", "")
    pid_t("pid", "")
}
...
val open_how = struct(Module.CORE_HAIKU, "OpenHow", nativeName = "struct open_how") {
    documentation =
        """
...
val epoll_data_t = union(Module.CORE_HAIKU, "EpollData", nativeName = "epoll_data_t") {
    opaque_p("ptr", "")
    int("fd", "")
    uint32_t("u32", "")
    uint64_t("u64", "")
...
val epoll_event = struct(Module.CORE_HAIKU, "EpollEvent", nativeName = "struct epoll_event") {
...
val iovec = struct(Module.CORE_HAIKU, "IOVec", nativeName = "struct iovec") {
...
val msghdr = struct(Module.CORE_HAIKU, "Msghdr", nativeName = "struct msghdr") {
...
val sockaddr = struct(Module.CORE_HAIKU, "Sockaddr", nativeName = "struct sockaddr") {
...
val cmsghdr = struct(Module.CORE_HAIKU, "CMsghdr", nativeName = "struct cmsghdr") {
...
val statx_timestamp = struct(Module.CORE_HAIKU, "StatxTimestamp", nativeName = "struct statx_timestamp") {
...
val statx = struct(Module.CORE_HAIKU, "Statx", nativeName = "struct statx") {
...
val __kernel_timespec = struct(Module.CORE_HAIKU, "KernelTimespec", nativeName = "struct __kernel_timespec") {
